...
import type { ExtrinsicPayload } from "src/hooks/helper";
...
import type { ChainAsset } from "./useXcmAssets";
...
class ChainApi {
  ...
  public async getNativeBalance(address: string) {
    try {
      ...
      const balData = ((await this._api.query.system.account(address)) as any)
        .data;
